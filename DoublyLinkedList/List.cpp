...
list::list(const data_type arr[], int length) : head(nullptr), tail(nullptr), _size(0) { assign(arr, length); }
list::list(const list& that) : head(nullptr), tail(nullptr), _size(0) { *this = that; }
...
// Modifiers
void list::assign(const list& that) { *this = that; }
