...
public:
	...
	bool operator==(Date& rhs) {
		return (getYear() == rhs.getYear()) && (getMonth() == rhs.getMonth()) && (getDay() == rhs.getDay());
	}
	bool operator!=(Date& rhs) {
		return !(*this == rhs);
	}
	...
	int& operator[](string s) {
		if (s == "year") { return _year; }
		else if (s == "month") { return _month; }
		else if (s == "day") { return _day; }
	}
	int operator[](string s) const {
		if (s == "year") { return getYear(); }
		else if (s == "month") { return getMonth(); }
		else if (s == "day") { return getDay(); }
	}
};
